...
void loadData(const char* name, dataset_t* d){
    ...
    d->target=(int*)malloc(d->nex*sizeof(int));
    d->oobvotes=(int*)calloc(d->nex,sizeof(int));
    d->weight=(float*)malloc(d->nex*sizeof(float));

    em=(evpair_t*)malloc(total*sizeof(evpair_t));
    fm=(int*)malloc(total*sizeof(int));
    ...
    d->size=(int*)calloc(d->nfeat,sizeof(int));
    d->cont=(int*)calloc(d->nfeat,sizeof(int));
    ...
    d->feature=(evpair_t**)malloc(d->nfeat*sizeof(evpair_t*));
    d->feature[0]=em;

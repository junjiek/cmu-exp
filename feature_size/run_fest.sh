...
echo 'featureSize,sampleSize,testAcc,time' > liblinear_$2.out
echo 'featureSize,sampleSize,testAcc,time' > fest_boosting_$2.out
echo 'featureSize,sampleSize,testAcc,time' > fest_randomforest_$2.out

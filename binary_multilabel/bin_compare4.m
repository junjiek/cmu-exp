function bin_compare4(id)
    ...
    g3 = plot(Mchi1(:,1), Mchi1(:,3), '-');
    g4 = plot(Mt1(:,1), Mt1(:,3), 'm-');
    xlabel('Feature Size');
    ...
    g3 = plot(Mchi1(:,1), Mchi1(:,6), '-');
    g4 = plot(Mt1(:,1), Mt1(:,4), 'm-');
    xlabel('Feature Size');
    ylabel('Running Time (s)');
    legend([g1,g2,g3,g4],'liblinear random','liblinear IG', 'liblinear CHI^2','liblienar t-test');
    
    subplot(323);
    hold on;
    g1 = plot(Mr2(:,1), Mr2(:,3), 'k-');
    g2 = plot(Mig2(:,1), Mig2(:,3), 'r-');
    g3 = plot(Mchi2(:,1), Mchi2(:,3), '-');
    g4 = plot(Mt2(:,1), Mt2(:,3), 'm-');
    xlabel('Feature Size');
    ylabel('Testing Accuracy (%)');
    ...
    g3 = plot(Mchi2(:,1), Mchi2(:,4), '-');
    g4 = plot(Mt2(:,1), Mt2(:,4), 'm-');
    xlabel('Feature Size');
    ylabel('Running Time (s)');
    
    legend([g1,g2,g3,g4],'BT random','BT IG', 'BT CHI^2', 'BT t-test');
    ...
    g3 = plot(Mchi3(:,1), Mchi3(:,3), '-');
    g4 = plot(Mt3(:,1), Mt3(:,3), 'm-');
    xlabel('Feature Size');
    ylabel('Testing Accuracy (%)');
    ...
    g3 = plot(Mchi3(:,1), Mchi3(:,4), '-');
    g4 = plot(Mt3(:,1), Mt3(:,4), 'm-');
    xlabel('Feature Size');
    ylabel('Running Time (s)');
    legend([g1,g2,g3,g4],'RF random','RF IG', 'RF CHI^2', 'RF t-test');
